...
import {fetchObservations, fetchInteractionPeriods, fetchInteractionTotals, updateCurrentVisualization, locations, gridSummary} from './actions/insightsActions';
      ...
      if (location.pathname.indexOf('wf/events/insights/dashboard') !== -1) {
        ...
        if (location.pathname.indexOf('wf/events/insights') !== -1) {
          ...
          store.subscribe(() => {
            ...
            if (visualization === 'gridSummary') observationsData =  _.get(state, `insights.observations`);
