...
class ActivityTimelineControls extends React.Component {
  ...
  render() {
    ...
    let endDatePicker = '';
    if (_.includes(['studentSummary', 'interactionTotals', 'unitSummary', 'socialGraph'], this.props.insights.ui.visualization)) {
      endDatePicker = (
        <div className="row">
            ...
            <form>
              <div className="form-group">
                ...
                <select className="form-control" name="select-entity" value={this.props.insights.ui.visualization} onChange={this.handleVisualizationSelect}>
                  ...
                  <option key={`interaction-totals`} value={`interactionTotals`}>InteractionTotals</option>
